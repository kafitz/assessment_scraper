...
class ParseTable(object):
    ''' This class is specific to evalweb.ville.montreal.qc.ca and is never
        intended to be adaptable other than as a simple model.'''
    ...
    def extract_tables(self):
        ...
        table' html tag because of programming on assessment page.'''
    ...
    def parse_table1(self, table):
        ## Unicode objects stored to tuple (if tuple printed, text will be different that tuple[index]
        header = 'IDENTIFIANTS'
        # Split string on whitespace and rejoin it, removing excess between words
    ...
    def parse_table2(self, table):
        ...
        non_residential_tuple = ("non-residential_class", table[21]) # None if false
    ...
    def parse_table3(self, table):
        header = 'VALEUR AU ROLE ANTERIEUR'
    ...
    def parse_table4(self, table):
        header = 'VALEUR AU ROLE 2011 EN DATE DU 2013-03-07'
